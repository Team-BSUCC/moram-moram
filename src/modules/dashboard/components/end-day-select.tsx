...
const EndDaySelect = ({ handleChangeDate, month, year }: EndDaySelectProps) => {
  ...
  const handleSelect = (value: string) => {
    ...
    handleChangeDate((prev) => {
      return { ...prev, endDay: value };
    });
    setIsOpen(false);
  };

  return (
    <div className='relative max-h-[35px] w-full max-w-[90px]'>
      <div
